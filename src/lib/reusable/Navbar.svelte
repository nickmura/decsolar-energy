...
<header class="flex w-full bg-white py-1 px-5 justify-between">
  <a href="/"
    ><img src="/img/Logo.svg" alt="dec energy logo" class="text-4xl" /></a
  >
      ...
      <ul class="flex items-center gap-6 ">
        {#each menu as item}
          <li>
            ...
            {:else if $page.route.id == '/join' && item.name == 'Games'}
